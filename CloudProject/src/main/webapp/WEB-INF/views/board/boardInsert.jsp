               ...
               <div class="mail-option">   
                  <h2 style="display:inline-block;">공지사항 작성</h2>   
                     ...
                     <table class="table table-inbox table-hover">
                      ...
                      <td class="view-message "><textArea rows="1" cols="100" name="boardTitle" id="boardTitle" style="resize: none;"></textArea></td>
                          </tr>
                          <tr>
                           <td class="view-message ">내용</td>
                      <td class="view-message "><textArea rows="10" cols="100" name="boardContent" id="boardContent" style="resize: none;"> </textArea></td>
                          </tr>
                        </tbody>
                     </table>
                     <input type="submit" value="등록" class="btn btn-compose" style="margin-top: 20px; width: 10%; float:right; height: 30px; padding: 0;">
                    </form>
               </div>
            </div>
         </aside>
